...
class BallPulseFooterWidgetState extends State<BallPulseFooterWidget> {
  ...
  bool get _success => widget.linkNotifier.success;
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                new Offstage(offstage: !_success,
                child: new Padding(
                    padding: EdgeInsets.only(top: 0),
                    child: new Image.asset('assets/imgs/free_checking_white.gif', width: 40, height: 40,)),),
//                SizedBox(
//                  width: 20.0,
//                  height: 20.0,
//                  child: Center(
